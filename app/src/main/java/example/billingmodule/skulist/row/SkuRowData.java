 ...
 */
package example.billingmodule.skulist.row;
...
import example.billingmodule.skulist.SkusAdapter;
...
public class SkuRowData {
    ...
    private @SkusAdapter.RowTypeDef int type;
    ...
    public @SkusAdapter.RowTypeDef int getRowType() {
        return type;
    }
